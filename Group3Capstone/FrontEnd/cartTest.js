...
const getOrderID ='http://localhost:8082/api/getOrderID'; 
...
//we will have to add where we can add the customer num per order
getOrderNum()
openPopup()
...
var displayOrderNum = document.getElementByClassName("displayOrderNum")[0];

function getOrderNum(){
fetch(getOrderID, otherParams)
.then((response) => response.text())
.then((data) => {
	console.log(data)
	document.getElementsByClassName("displayOrderNum")[0].innerText = "Order Number: " + data;
	})
}
